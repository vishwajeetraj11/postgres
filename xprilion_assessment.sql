...
orders.cust_code,
customer.cust_name,
agents.working_area AS "Agent Working Area",
customer.working_area AS "Customer Working Area",
agents.commission,
orders.ord_amount,
ROUND(orders.ord_amount*agents.commission,2) AS "Earned"
FROM
orders
INNER JOIN agents
...
WHERE TRIM(agents.working_area) != TRIM(customer.working_area)
;

SELECT 
agents.working_area AS "Agent Working Area",
customer.working_area AS "Customer Working Area"
FROM customer INNER JOIN agents ON customer.agent_code = agents.agent_code
WHERE TRIM(customer.working_area) != TRIM(agents.working_area)
;

INSERT INTO orders (ORD_NUM, ORD_AMOUNT, ADVANCE_AMOUNT, ORD_DATE, CUST_CODE, AGENT_CODE, ORD_DESCRIPTION) VALUES
('200100', '1000.00', '600.00', '2008-01-08', 'C00018', 'A003  ', 'SOD\r'),
('200110', '3000.00', '500.00', '2008-04-15', 'C00020', 'A007  ', 'SOD\r');
